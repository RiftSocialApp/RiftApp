    ...
    extend: {
      colors: {
        riftapp: {
          ...
          'chrome-hover': '#35373c',
          content: '#313338',
          'content-elevated': '#3b3d44',
          surface: '#313338',
          'surface-hover': '#3b3d44',
          menu: '#111214',
          'menu-hover': '#1a1b1e',
          panel: '#1e1f22',
          'panel-hover': '#232428',
          ...
          'mention-highlight-bg': '#4a3f23',
          'mention-highlight-hover': '#5a4b28',
          'mention-highlight-border': '#faa61a',
          'mention-pill-bg': '#4752c4',
          'mention-pill-hover': '#5865f2',
          'mention-pill-text': '#dee0fc',
          /** Discord-style active speaker ring */
          'voice-speaking': '#3ba55d',
