...
export default function DMSidebar() {
  ...
  return (
    <div className="w-60 flex-shrink-0 bg-riptide-surface flex flex-col">
      {/* Search bar */}
      <div className="h-12 flex items-center px-3 border-b border-riptide-border/60 flex-shrink-0 shadow-[0_1px_0_rgba(0,0,0,0.1)]">
        <button
          onClick={handleSearchToggle}
          className="w-full h-[28px] flex items-center gap-2 px-2 rounded bg-riptide-bg/80 text-riptide-text-dim text-[13px] hover:bg-riptide-bg transition-colors"
        >
      ...
      <div className="px-4 pt-2 pb-1">
        <div className="flex items-center justify-between">
          <h3 className="text-[11px] font-semibold uppercase tracking-wider text-riptide-text-dim">Direct Messages</h3>
          <button
            onClick={() => { if (!showSearch) handleSearchToggle(); }}
            title="New direct message"
            className="w-5 h-5 flex items-center justify-center text-riptide-text-dim hover:text-riptide-text transition-colors"
          >
